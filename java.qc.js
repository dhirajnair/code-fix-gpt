...
async function qcJavaIssue(filePath, issue) {
    try {
        ...
        const systemContent = "Context: You are Ack, a detail-oriented software developer, with a strong background in Java and related technology stack, specifically Java 8, Tomcat 8.5, Junit, Struts 2.3, EJB 3, Hibernate, Spring Framework, Oracle database, VoltDB, XML, Security vulnerability.\n\
                              ...
                              - The text \"ISSUE\" will have a short description of the issue.\n\
                              - The text \"QUESTION1\" will have a question,related to \"ISSUE\".\n\
                              - The text \"QUESTION2\" will have a question,related to syntax in code.\n\
                              - Respond with a JSON with two keys \"qc_fix\" and \"qc_syntax\".\n\
                              - If the answer to QUESTION1 is yes then \"qc_fix\" will be false else it will be true.If \"qc_fix\" is false you MUST provide the reason for the same in \"qc_fix_reason\".\n\
                              - If the answer to QUESTION2 is yes then \"qc_syntax\" will be false else it will be true.If \"qc_syntax\" is false you MUST provide the reason for the same in \"qc_syntax_reason\".\n\
        ...
        let messages = [
            ...
            {
                role: 'user',
                content: `INPUT: ${fileContents}\nISSUE: ${issue}.\nQUESTION1: Is this ISSUE still present in the code?\nQUESTION2: Are there any syntax issues in the code?clear`
            }
        ];
        ...
        if (result.qc_fix === true && result.qc_syntax === true) {
